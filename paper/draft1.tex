...
% TODO: proof read for GFLOP vs. GFLOPS -> we want GFLOP


%XXX:  Machine Learning for Auto-tuning: A Data-Driven Approach...} ???
...
This shows that it is generally not enough to auto-tune for particular argument configurations;
...
% XXX: NPTODO: ERROR BARS
% XXX: NPTODO: fix fonts for better proportions
...
For 38/100 random configurations, the kernel auto-tuned for another problem could not even run on the GTX 295 hardware.
...
\begin{figure}
\centering
\includegraphics[scale=.42]{fig_ntrain_munctional0_580.pdf} % on vader
