...
% DDC: "sensible to"?  what is meant here? "Sensitive to?"
The empirical approach is very sensible to the choice of instrumented
...
In our experiments, this regression model is fit to empirically measured timing information for {\em some} elements of the configuration space, and the regression model interpolates and extrapolates that timing across the remainder of the space.
