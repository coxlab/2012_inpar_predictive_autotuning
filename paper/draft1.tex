...
methods called ``auto-tuning''. Two major auto-tuning approaches have emerged
...
analytical model-driven approach even more intractable. Due to its flexibility,
...
Even though this ``black-box'' approach does not necessarily try to build an
explicit model per se, it could, if care is taken, help to greatly accelerate
...
To alleviate this major weakness, it seems intuitive to combine the two
...
hope to get ``the best of both approaches'' and capitalize on the large body of
