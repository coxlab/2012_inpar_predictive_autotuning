...
\begin{abstract}
Auto-tuning of parameteric, instrumented code templates has proven to be a highly effective technique for optimizing a GPU code for a particular computation on particular
hardware \cite{XXXX}.  
