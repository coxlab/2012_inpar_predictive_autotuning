...
In our experiments we compare two strategies: (1) a hand-chosen grid provided by the authors of the kernel used in our experiments \citep{pinto+cox:2011gcg},
and (2) a generic stochastic hill-climbing search.
