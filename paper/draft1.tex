...
using the filterbank correlation kernel described in [XXX], where we find
...
\section{Filter-bank Correlation}
...
XXX, which serves as the basis for the present work.
...
\end{align*}
The problem configuration space used in our experiments. The product space
...
\mathrm{n\_output4s} & \in (\mathrm{all}, 1, 2) \\
